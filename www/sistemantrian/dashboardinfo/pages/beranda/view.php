			...
			<div class="row">
				<div class="col-md-4">
					...
					<div class="text-center">
						<button id="simpan_antria" class="btn btn-app btn-primary" style="font-size: 20px; padding: 20px; width: 500px;"data-toggle="modal" data-target="#modal-survey">
							<i class="ace-icon fa fa-info"></i> Informasi KI
						</button> 
					</div>
				...
				<div class="col-md-4">
					...
					<div class="text-center">
						<button id="simpan_antria" class="btn btn-app btn-primary " style="font-size: 20px; padding: 20px; width: 500px;"data-toggle="modal" data-target="#modal-survey">
							<i class="ace-icon fa fa-info"></i> Informasi AHU
						</button>
					</div>
					<br>
				</div>
				...
				<div class="col-md-4">
					...
					<div class="text-center">
						<button id="simpan_antria" class="btn btn-app btn-primary " style="font-size: 20px; padding: 20px; width: 500px;"data-toggle="modal" data-target="#modal-survey">
							<i class="ace-icon fa fa-info"></i> Informasi Kewarganegaraan
						</button>
					</div>
				</div>
				<br>
