...
?>    
                                            ...
                                            <div class="col-md-12">\
                                                <table class="table table-bordered">\
                                                    <tbody>\
                                                        ...
                                                        <tr>\
                                                            <td>Alamat</label</td>\
                                                            <td colspan="3"><b>' + msg.data.alamat + '</b></td>\
                                                        </tr>\
                                                        <tr>\
                                                ...
                                                <table class="table table-bordered">\
                                                    <tr>\
                                                        <th colspan="5">Bagaimana Pelayanan Kami?</th>\
                                                    </tr>\
                                                    <tr>\
                                                        <th><img style="cursor:pointer;" onClick="simpan_senyum(1,\''+id+'\')" border="0" src="../../sistemantrian/pengunjung/senyum1.png" width="60%"></th>\
                                                        <th><img style="cursor:pointer;" onClick="simpan_senyum(2,\''+id+'\')" border="0" src="../../sistemantrian/pengunjung/senyum2.png" width="60%"></th>\
                                                        <th><img style="cursor:pointer;" onClick="simpan_senyum(3,\''+id+'\')" border="0" src="../../sistemantrian/pengunjung/senyum3.png" width="60%"></th>\
                                                        <th><img style="cursor:pointer;" onClick="simpan_senyum(4,\''+id+'\')" border="0" src="../../sistemantrian/pengunjung/senyum4.png" width="60%"></th>\
                                                        <th><img style="cursor:pointer;" onClick="simpan_senyum(5,\''+id+'\')" border="0" src="../../sistemantrian/pengunjung/senyum5.png" width="60%"></th>\
                                                    </tr>\
                                                    <tr align="center">\
                                                        <td><h4>Sangat Tidak Puas</h4>\
                                                        <td><h4>Tidak Puas</h4></td>\
                                                        <td><h4>Biasa Ajah!</h4></td>\
                                                        <td><h4>Puas</h4></td>\
                                                        <td><h4>Sangat Puas</h4></td>\
                                                    </tr>\
                                                </table>\
                                            </div>\
                                        </div>\
    ...
    function simpan_senyum(nilai, id_antrian) {
        // alert(id_antrian);
        $.ajax({ 
            url   : "modules/antrian/prosesSenyum.php",
            type  : "POST",
            data  : { id_antrian : id_antrian, nilai : nilai },
            cache : false,
            success: function(msg){
                // console.log(msg);
                if(msg=="Sukses"){ 
                    ...
                    $.gritter.add({
                        ...
                        text: 'Semoga Senang dengan pelayanan kami.',
