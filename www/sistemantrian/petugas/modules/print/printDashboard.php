...
<h1>
  ...
  $antrianID = $_GET["antrianID"];

  $result2 = $mysqli->query("SELECT no_antrian FROM antrian WHERE ID = '$antrianID'") or die('Ada kesalahan pada query tampil data config: ' . $mysqli->error);
