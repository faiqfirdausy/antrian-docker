...
// jika user sudah login, maka jalankan perintah untuk pemanggilan file halaman konten
    ...
    <html lang="en" data-textdirection="ltr" class="loading">
        <head>
            ...
            <meta name="description" content="Aplikasi Antrian <?php echo $nama_instansi; ?>">
            <meta name="keywords" content="Aplikasi Antrian  <?php echo $nama_instansi; ?>">
        ...
        <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
            ...
            <footer class="footer footer-static footer-light navbar-border">
                <p class="clearfix text-muted text-sm-center mb-0 px-2">
                    ...
                    <span class="float-md-left d-xs-block d-md-inline-block">Sub Bagian Humas RB dan TI - <a href="https://jatim.kemenkumham.go.id" target="_blank" class="text-bold-500 grey darken-2">Kemenkumham Jatim</a></span>
                </p>
            </footer>
