...
<head>
	...
	<!--ace styles-->
	<link rel="stylesheet" type="text/css" href="assets/css/ace.min.css" class="ace-main-stylesheet"
		id="main-ace-style" />
			...
			<div class="footer-inner">
				<div class="footer-content">
					<span class="bigger-120">
						...
						Tim Komunikasi Publik dan Teknologi Informasi - <a style="text-decoration: underline;"
							href="https://jatim.kemenkum.go.id">Kemenkum
							Jatim</a>

						<!-- &copy; 2018 - <a style="color:#E5E5E5" href="http://<?php echo $website; ?>"><?php echo $nama_instansi; ?></a> -->
						<!--	Copyright &copy; 2019 - <a style="color:#E5E5E5" href="https://vannyhadiwijaya.com">Bank Central Asia</a> -->
					</span>
				</div>
			</div>
		</div>
