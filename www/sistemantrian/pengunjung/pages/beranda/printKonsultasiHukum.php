...
<img src="logo1-new.png" style="text-align: right !important;">
...
<h1>
  ...
  $result2 = $mysqli->query("SELECT no_antrian FROM antrian WHERE tanggal='$hari_ini' && layanan_antrian = '" . ANTRIAN_LAYANAN_KONSULTASI_HUKUM . "' ORDER BY ID DESC LIMIT 1") or die('Ada kesalahan pada query tampil data config: ' . $mysqli->error);
