...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ( $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' )) {
    ...
    $result = $mysqli->query("SELECT RIGHT(no_antrian,3) AS kode FROM antrian WHERE tanggal='$tanggal'  && layanan_antrian = 'Pelayanan Pojok Wani' ORDER BY ID DESC LIMIT 1")
                              or die('Ada kesalahan pada query tampil data id antrian: '.$mysqli->error);
    ...
    $layanan_antrian = 'Pelayanan Pojok Wani';
