...
<?php 
 // panggil file config.php untuk koneksi ke database
   ...
   $result2 = $mysqli->query("SELECT no_antrian FROM antrian WHERE tanggal='$hari_ini' && layanan_antrian = 'Pelayanan Keimigrasian' ORDER BY ID DESC LIMIT 1")or die('Ada kesalahan pada query tampil data config: '.$mysqli->error);
