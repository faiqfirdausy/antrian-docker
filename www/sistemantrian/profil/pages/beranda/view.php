	...
	<div class="page-header">
		<div style="margin-top:10px;margin-bottom:5px" class="row">
			<div class="col-xs-12">
				...
				<h1 style="color:#000;font-size:30px"><strong><?php echo strtoupper($nama_instansi); ?></strong></h1>
			</div>
		</div>
	</div>

	<div class="alert alert-dark-blue">
		<i style="margin-right:5px" class="ace-icon fa fa-info-circle"></i> Selamat Datang di <?php echo $nama_instansi; ?>. 
	</div>
